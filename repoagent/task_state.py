...
STOP_REASON_TOOL_CANCELLED = "tool_cancelled"
...
class TaskState:
    ...
    def stop_tool_cancelled(self, final_answer=""):
        return self.stop(STOP_REASON_TOOL_CANCELLED, final_answer=final_answer)
